  ...
  <div class="personalData-container">
    <div class="k-pd-function">
      <div class="k-pd-grounp">
        <van-cell v-if="!isWeiXin" is-link @click="chooseImageFn">
          <template #title>
            <span class="custom-title">头像</span>
            <img :src="userInfoSaveModel.headImg" class="avatar" @click.stop.prevent="priviewAvatar">
          </template>
        </van-cell>
        <van-cell v-else is-link class="vanUploadImg">
          <template #title>
            <span class="custom-title">头像</span>
          </template>
          <van-uploader v-model="uploadNoWeixin" :after-read="h5ChooseImage" :max-count="1" :preview-image="false">
            <div class="noWeixin">
              <img :src="userInfoSaveModel.headImg" class="avatar avatar1" preview-size="36px" @click.stop.prevent="priviewNoweixin">
            </div>
          </van-uploader>
        </van-cell>
